...
const { CiCirclePlus, AiOutlineLogout, IoIosArrowDown } = icons
            ...
            <div className='w-full flex items-center justify-between '>
                ...
                <div className='flex items-center gap-1'>
                    ...
                    {isLoggedIn && <div className='flex items-center gap-3 relative'>
                        <User />
                        {/* <span>Xin chào, {currentData.name}</span> */}
                        <Button text={'Quản lý tài khoản'} IcAfter={IoIosArrowDown} textColor='text-white' bgColor='bg-blue-700' px='px-4' onClick={() => setIsShowMenu(prev => !prev)}
                        />
                    ...
                    <Button onClick={() => navigate('/he-thong/tao-moi-bai-dang')}
                        text={'Đăng tin mới'} textColor='text-white' bgColor='bg-secondary2' IcAfter={CiCirclePlus} />
                </div>
            </div>
        </div>
    )
