        ...
        <div className='flex flex-col h-full items-center'>
            ...
            <div className='w-3/5 flex items-center justify-center flex-auto'>
                <div className='w-full py-6 flex flex-col gap-4 '>
                    ...
                    <InputFormV2 name='name' setValue={setPayload} value={payload.name} direction='flex-row' label='Tên hiển thị' />
                    ...
                    <div className='flex mb-6'>
                        <label className='w-48 flex-none' htmlFor='avarta'>Ảnh đại diện</label>
                        <div>
                            <img src={payload.avatar || anonAvatar} alt='avarta' className='w-28 h-28 rounded-full object-cover' />

                            <input onChange={handleUploadFile} type='file' className='appearance-none my-4' id='avatar' />
                        </div>
                    </div>

                    <Button onClick={handleSubmit} text='Cập nhật' bgColor='bg-secondary1' textColor='text-white' />
                </div>
            </div>
        </div>
    )
